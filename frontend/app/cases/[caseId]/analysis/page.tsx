...
const sections = [
  {
    ...
    bgGlow: "group-hover:shadow-[0_0_40px_rgba(6,182,212,0.08)]",
  },
  {
    key: "notes",
    label: "Analyst Notes",
    ...
    bgGlow: "group-hover:shadow-[0_0_40px_rgba(251,191,36,0.08)]",
  },
  {
    key: "cross-check",
    ...
    bgGlow: "group-hover:shadow-[0_0_40px_rgba(52,211,153,0.08)]",
  },
  {
    key: "five-cs",
    ...
    bgGlow: "group-hover:shadow-[0_0_40px_rgba(251,113,133,0.08)]",
  },
];
      ...
      <div className="grid gap-4 sm:grid-cols-2 xl:grid-cols-4">
        {sections.map((section, i) => (
          <Link
            ...
            className={`group panel p-5 transition-all duration-300 hover:border-white/[0.12] ${section.bgGlow} animate-slide-up stagger-${i + 1}`}
          >
            <div className="flex items-start justify-between">
              <div className={`flex h-10 w-10 items-center justify-center rounded-xl bg-surface-200 ${section.color}`}>
                {section.icon}
              </div>
